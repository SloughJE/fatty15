...
<div style="display: flex; justify-content: center; align-items: center; height: 100%;">
  ...
  Fatty15's GRAS status is self-declared.<br>Not public. FDA has not reviewed or approved it.
  </h2>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100%;">
  <h2 style="border-top: 1px solid #fff; border-bottom: 1px solid #fff; padding: 0.5em 0;">
  In my view: promoting C15 as substitute for omega-3 is borderline unethical.<br>Decades of omega-3 research vs. one founder-run cell study.
  </h2>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100%;">
  <h2 style="border-top: 1px solid #fff; border-bottom: 1px solid #fff; padding: 0.5em 0;">
  Only one RCT on C15 supplementation benefits.<br>Results were very weak.
  </h2>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100%;">
  <h2 style="border-top: 1px solid #fff; border-bottom: 1px solid #fff; padding: 0.5em 0;">
  Fatty15 RCT: half didn't increase C15 levels.<br>Benefit claims, based on statistical shenanigans, were overstated.
  </h2>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100%;">
  <h2 style="border-top: 1px solid #fff; border-bottom: 1px solid #fff; padding: 0.5em 0;">
  From the 2 actual RCTs on C15:<br>No replication of minor positive findings
  </h2>
</div>
...
- Marketing reads like parody or satire
