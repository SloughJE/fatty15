...
![](assets/ecological_fallacy.png){width=100% fig-align="center"}

Source: [Venn-Watson TEDx Talk](https://www.youtube.com/watch?v=k1yRoeAeI68&t=4m21s)
...
- Three-group KW test only answers: ["Are **any** of the three groups different?"](https://www.graphpad.com/guides/prism/latest/statistics/how_the_kruskal-wallis_test_works.htm), [**not which**](https://en.wikipedia.org/wiki/Kruskal–Wallis_test) groups differ.
- *"as compared with participants that did not reach >5 μg/mL"*: reads like a **specific two-group comparison** (≥5 μg/mL **vs** <5 μg/mL). [The KW test alone does **not** test that claim.](https://www.biostathandbook.com/kruskalwallis.html)
...
"In an exploratory three-group comparison (placebo, sub-threshold, threshold), Kruskal–Wallis tests on change scores were significant for ALT/AST, indicating at least one group differed; we did not perform furtherstatistical tests to determine which groups differed. Additionally, this analysis does not control for baseline levels."
...
[**Seraphina Therapeutics** (and fatty15) was co-founded by Stephanie Venn-Watson](https://fatty15.com/pages/stephanie-venn-watson). They make fatty15.
...
[2021 Study from J Clin Invest](https://pmc.ncbi.nlm.nih.gov/articles/PMC8670836/): 
...
"J.B.S. reports grants to UCSD from Intercept and **Seraphina** outside the submitted work"

:::
:::{.fragment}

[2023 Study from J P Gastro Nut](https://pmc.ncbi.nlm.nih.gov/articles/PMC10523882/):
"Jeffrey B. Schwimmer received grants from Intercept, Genfit, and **Seraphina**."
...
[2025 Study from J Clin Invest](https://pubmed.ncbi.nlm.nih.gov/40590222/) Conflict of interest:     
...
- **Gut microbiome**  
  **Limited/neutral (human):** In NAFLD (TANGO) trial, *Bifidobacterium adolescentis* increase reported with C15:0, but **no broader microbiome “health” or clinical GI benefits** established.  
