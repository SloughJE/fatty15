...
<div style="display: flex; justify-content: center; align-items: center; height: 100%;">
  ...
  The dose-response relationship claimed is not in those papers.<br><br>It’s methodologically indefensible.<br><br>100% bioavailable = 100% fabrication
  </h3>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; height: 100%;">
  <h2 style="border-top: 1px solid #fff; border-bottom: 1px solid #fff; padding: 0.5em 0;">
  Fatty15 RCT:<br>It does not reliably increase C15 levels.<br><br>Benefit claims, based on statistical shenanigans, were incorrectly stated.
  </h2>
</div>
